...
INSERT INTO profile (id, firstname, nickname, lastname, sunrise, sunset, branch) VALUES
    ...
    (gen_random_uuid(), 'John', NULL, 'Doe2', '1939-06-03', '2024-05-11', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe3', '1931-05-09', '2003-03-05', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe4', '1934-12-25', '2014-05-12', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe5', '1941-04-27', '2008-06-19', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe6', '1947-04-27', '2010-06-02', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John1', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John2', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John3', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John4', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John5', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John1243', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John6', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John7', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John8', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John9', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John0', NULL, 'Doe7', '1950-01-28', '2018-08-18', 1),
    (gen_random_uuid(), 'John11', NULL, 'Doe8', '1955-12-04', '2003-02-09', 1),
    (gen_random_uuid(), 'John13', NULL, 'Doe8', '1955-12-04', '2003-02-09', 1),
    (gen_random_uuid(), 'John15', NULL, 'Doe8', '1955-12-04', '2003-02-09', 1),
    (gen_random_uuid(), 'John12', NULL, 'Doe9', '1929-08-28', '2009-05-12', 1),
    (gen_random_uuid(), 'John13', NULL, 'Doe10', '1932-06-29', '1993-01-23', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe11', '1936-02-25', '2020-05-27', 1),
    (gen_random_uuid(), 'John', NULL, 'Doe12', '1943-11-20', '2007-01-06', 1);
